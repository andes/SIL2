...
namespace ImprimeLocal
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            textBox1.Text = buscarUltimoProtocolo();
 ...
 //       }
        ...
        private void BorrarColaImpresion()
        {
            ...
            string query = @"delete from LAB_ProtocoloEtiqueta where impresora= '" + s_impre + "'";
            SqlCommand cmd = new SqlCommand(query, conn);
        ...
        private void ImprimirCodigoBarras(Protocolo oProt, int idAreaImprimir)
        {
            ...
            if (oTipo.IdTipoServicio == 6)
            {
                ...
                oConBarra = (ConfiguracionCodigoBarra)oConBarra.Get(typeof(ConfiguracionCodigoBarra), "IdTipoServicio", oTipo3);
            }
            else
