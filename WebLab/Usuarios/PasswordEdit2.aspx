<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordEdit2.aspx.cs" Inherits="WebLab.Usuarios.PasswordEdit2" MasterPageFile="~/Site1.Master" %>
 ...
 <div class="panel panel-default">
     ...
     <div class="panel-body">
      ...
      <div class="panel-footer">
             <asp:Button ID="btnGuardar" runat="server" Text="Grabar" Width="100px"
                        onclick="btnGuardar_Click1"    CssClass="btn btn-primary" ValidationGroup="0" />
        
             
             <asp:Button ID="btnContinuar" runat="server" Text="Continuar" Width="100px"
                        onclick="btnContinuar_Click"    CssClass="btn btn-primary" /> 
