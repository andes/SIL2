     ...
     <div align="left" style="width: 1200px" class="form-inline"  >
      <div class="panel panel-default">
                ...
                <div class="col-sm-6"> <h3  >   <asp:Label ID="lblTitulo"   runat="server" Text="CARGA DE RESULTADOS" ></asp:Label> </h3> 
                     ...
                     <asp:Button ID="btnMostrarResultados" runat="server"
                   ...
                   <div id="pnlObservaciones" runat="server">
                        Aplicar Observacion:<asp:DropDownList CssClass="form-control input-sm" ID="ddlObservacionesCodificadas" runat="server"></asp:DropDownList>
    
                            <asp:Button accesskey="s" title="Alt+Shift+S" ID="btnGuardarObservaciones" runat="server" CssClass="btn btn-success" Text="Aplicar" 
                                onclick="btnGuardarObservaciones_Click" ValidationGroup="0" Width="100px"/> 
                    </div>
