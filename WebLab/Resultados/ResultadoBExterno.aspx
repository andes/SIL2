<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoBExterno.aspx.cs" Inherits="WebLab.Resultados.ResultadoBExterno" MasterPageFile="~/PeticionElectronica/SitePE.Master" %>
    ...
    <div  style="width: 1000px" class="form-inline" >
     <table  width="950px" align="center" >
					...
					<td >
                     ...
                     <div class="panel panel-success" runat="server" id="pnlTitulo">
         ...
         <asp:Image ID="imgUrgencia" ToolTip="URGENCIA" runat="server" ImageUrl="../App_Themes/default/images/urgencia.jpg" />   
					...
					<tr>
						<td  valign="top" rowspan="12" >
                            ...
                            <div class="panel panel-default" runat="server" id="Div1" visible="false">
                    <div class="panel-heading">
    <asp:Label ID="lblFormaCarga" runat="server" 
                                Text="Forma de Carga" Visible="False" ></asp:Label>
  </div>
                    <div class="panel-body">
                        <div class="radio">
                                   <anthem:RadioButtonList ID="rdbCargaResultados" runat="server" 
                                       ...
                                       <Items>
                                           ...
                                           <asp:ListItem Value="2" Selected="True">Analisis</asp:ListItem>
                                       </Items>
                            ...
                            <div class="panel panel-default" runat="server" id="Div2" style="width:300px;">
                    <div class="panel-heading">
    Estado 
  </div>
                    <div class="panel-body">
                            ...
                            <asp:RadioButtonList ID="rdbEstado" runat="server" 
                                TabIndex="13" ToolTip="Seleccione el estado de los protocolos a buscar" Width="249px">
    ...
    Firma electronica
                    ...
                    <div class="panel-body" >
                                  ...
                                  <table style="width:200px;">
                                      ...
                                      <tr>
                                          <td align="left">
                                              <asp:HyperLink ID="hplCambiarContrasenia"  runat="server" Visible="False">Cambiar Contraseña</asp:HyperLink>
                                          </td>
                                      </tr>
                                  </table>
					...
					<tr>
						<td class="myLabelIzquierda"><anthem:RangeValidator ID="rvArea" runat="server" 
						...
						<td colspan="3">
                            <anthem:DropDownList ID="ddlArea" runat="server" 
                               ...
                               AutoPostBack="True"  onselectedindexchanged="ddlArea_SelectedIndexChanged" Visible="False">
                            </anthem:DropDownList>
                                        
                            <anthem:DropDownList ID="ddlHojaTrabajo" runat="server" 
                                ToolTip="Seleccione la hoja de trabajo" TabIndex="2" class="form-control input-sm" Visible="False">
                            </anthem:DropDownList>
                            ...
                            <anthem:RangeValidator ID="rvHojaTrabajo" runat="server" 
                                ...
                                ImageUrl="~/App_Themes/default/images/add.png" Visible="False" />
					...
					<tr>
						...
						<td>
                            <asp:TextBox ID="txtNroOrigen" runat="server" class="form-control input-sm" TabIndex="7"  style="width: 100px"
                                ToolTip="Ingrese numero de origen" Visible="False"></asp:TextBox>
						...
						<td>
                            ...
                            <anthem:DropDownList ID="ddlPrioridad" runat="server" 
                                ToolTip="Seleccione la prioridad" TabIndex="9" class="form-control input-sm" Visible="False">
                            </anthem:DropDownList>
						...
						<td colspan="3">
                            <asp:DropDownList ID="ddlEfector" runat="server" Width="350px"
                                ToolTip="Seleccione el efector" TabIndex="10" class="form-control input-sm" Visible="False">
                            </asp:DropDownList></td>
					...
					<tr>
						...
						<td>
                            <asp:DropDownList ID="ddlOrigen" runat="server" 
                                ToolTip="Seleccione el origen" TabIndex="8" class="form-control input-sm" Visible="False">
                            </asp:DropDownList>
                            
                        </td>
						<td class="myLabelIzquierda">
                            <asp:Label id="lblDniPaciente" runat="server" Visible="False"> DNI Paciente:</asp:Label></td>
						<td>
                    ...
                    <input id="txtDNI" runat="server" type="text" maxlength="10"                        
                       tabindex="11" class="form-control input-sm" style="width: 120px"
                                ...
                                title="Ingrese el DNI del paciente" visible="False"  /><asp:CompareValidator 
					...
					<tr>
						...
						<td class="myLabelIzquierda">&nbsp;</td>
						<td>
                             <asp:CheckBox ID="chkFactura" runat="server" Text="Solo Para Facturar" Visible="False" /> 
                        </td>
						<td class="myLabelIzquierda">
                            &nbsp;</td>
						<td>
					...
					<tr>
                       ...
                       <%--<h4>     <label class = "label label-danger" style="vertical-align: top"> Caracter-CoVid19: </label></h4>--%>
					                <br />
    
                                            <asp:CheckBoxList ID="chkCaracterCovid" runat="server" RepeatDirection="Vertical" RepeatColumns="4" Visible="False">
                                           </asp:CheckBoxList>
						...
						<td style="height: 12px" colspan="4">
                            <div class="panel panel-default" runat="server" id="Div3" visible="false">
                    <div class="panel-heading">
  Sector/Servicio
  </div>
                    <div class="panel-body" style="visibility=false">
					...
					<table width="100%">
						...
						<td align="right">
                             <asp:LinkButton ID="lnkBuscar" runat="server" CssClass="btn btn-success" OnClick="btnBuscar_Click"    Width="100px" ValidationGroup="0" >
