<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepositorioxNroEdit.aspx.cs" Inherits="WebLab.Resultados.RepositorioxNroEdit" MasterPageFile="~/Site1.Master" %>
   ...
   <div  style="width: 1200px" class="form-inline" >
           <div class="panel panel-danger" runat="server" > 
                    <div class="panel-heading"> 
                        <h3 class="panel-title">IDENTIFICACION DE REPOSITORIO - NUEVA CAJA</h3>
     ...
     <tr>
         ...
         <td class="auto-style1">
          <h3>    <asp:Label ID="lblProcesado" runat="server" Text="Caja generada en este paso " Visible="false"></asp:Label></h3>
                ...
                <anthem:Button  CssClass="btn btn-danger" ID="btnAgregar" runat="server" Width="100px" 
     ...
     <asp:Button ID="btnValidar" runat="server" onclick="btnGuardar_Click"   CssClass="btn btn-danger" Width="200px"
                Text="GENERAR CAJA" TabIndex="4" />
         ...
         <anthem:GridView ID="gvLista" runat="server" AutoGenerateColumns="False"
                DataKeyNames="idProtocolo" CssClass="table table-bordered bs-table"  Font-Names="Arial" Font-Size="12pt"
