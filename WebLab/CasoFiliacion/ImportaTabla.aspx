<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportaTabla.aspx.cs" Inherits="WebLab.CasoFiliacion.ImportaTabla" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
   ...
   <div  style="width: 700px"  class="form-inline" >
           <div class="panel panel-default" runat="server" > 
                    <div class="panel-heading"> <h3 class="panel-title">Importación </h3>
