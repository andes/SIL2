<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CasoForenseView.aspx.cs" Inherits="WebLab.CasoFiliacion.CasoForenseView" MasterPageFile="~/Site1.Master" %>
     ...
     <table  width="900px" align="left" >
					...
					<tr>
						...
						<td>   
                            ...
                            <anthem:Button ID="btnAgregar" runat="server" 
                               ...
                               CssClass="btn btn-success" Width="80px"  TabIndex="22" Enabled="False" AutoUpdateAfterCallBack="True" />   
        ...
        <EmptyDataRowStyle forecolor="Red" CssClass="table table-bordered" />
					...
					<tr>
						...
						<td align="right">
                                            ...
                                            <asp:Button ID="btnEliminar" runat="server" Text="Anular Ingreso" ValidationGroup="0" 
                                            CssClass="btn btn-danger" Width="120px"  TabIndex="24" OnClientClick="eliminar(); return false;" />
                                               
                                            <asp:Button ID="btnCaratula" runat="server" Text="Imprimir Caratula" ValidationGroup="0" 
                                                onclick="btnCaratula_Click" CssClass="btn btn-danger" Width="200px"  TabIndex="24" />
                                            ...
                                            <asp:Button ID="btnPresupuesto" runat="server" Text="Presupuesto" ValidationGroup="0" 
                                                onclick="btnPresupuesto_Click" CssClass="btn btn-danger" Width="100px"  TabIndex="24" />
                                        
                                            <asp:Button ID="btnGuardar" runat="server" Text="Guardar" ValidationGroup="0" 
                                                onclick="btnGuardar_Click" CssClass="btn btn-danger" Width="80px"  TabIndex="25" />
                            <br />
                              <div>
       ...
       <div class="panel-footer">
       	...
       	<div class="panel-body">	
               <table>
                   <tr>
                       <td> <h5>Importar Muestras de Caso de Referencia</h5></td>
                     
                   </tr>
                   <tr>
                         <td>   <div>
                                <anthem:Panel ID="pnlCopia" runat="server" Visible="true">
                                <anthem:TextBox ID="txtNroCasoOriginal" runat="server" Text="" class="form-control input-sm" OnTextChanged="txtNroCasoOriginal_TextChanged" AutoCallBack="True"></anthem:TextBox>
                                <anthem:Label ID="lblCasoOriginal" runat="server" class="form-control input-sm" Text="Ingrese numero de caso"></anthem:Label>                                        
                                    </anthem:Panel>        
                                            
                            </div></td>
                       <td>     <asp:Button ID="btnCopiar" runat="server" Text="Importar"  CssClass="btn btn-danger" Width="100px"  TabIndex="24" OnClick="btnCopiar_Click" />
                                   </td>
                   </tr>
