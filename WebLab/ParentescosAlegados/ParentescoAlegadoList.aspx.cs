...
{
    public partial class ParentescoAlegadoList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = " select idParentesco,nombre" +
                              " from Lab_Parentesco" +                              
                              " where baja=0 " +
                              " order by nombre";
        ...
        {
            Response.Redirect("ParentescoAlegadoEdit.aspx");
        }
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                MyURL = "ParentescoAlegadoEdit.aspx?id=" + e.CommandArgument.ToString();
        ...
        private void Eliminar(object p)
        {
            ...
            oRegistro = (ParentescoAlegado)oRegistro.Get(typeof(ParentescoAlegado), int.Parse(p.ToString()));
