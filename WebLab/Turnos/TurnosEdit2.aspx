                                            ...
                                            <td colspan="3" style="vertical-align: top">
                                                ...
                                                <fieldset id="Fieldset2">
                                                    ...
                                                    <table align="left" width="100%">
                                                        <tr>
                                                            <td class="myLabelIzquierda" colspan="3">Codigo: &nbsp; &nbsp;
                                                 <anthem:TextBox ID="txtCodigoDiagnostico" runat="server" AutoCallBack="True"
                                                     CssClass="form-control input-sm" OnTextChanged="txtCodigoDiagnostico_TextChanged"></anthem:TextBox>
                                                        ...
                                                        <tr>
                                                            <td class="myLabelIzquierda" colspan="3">Nombre: &nbsp;<anthem:TextBox ID="txtNombreDiagnostico" runat="server" AutoCallBack="True"
                                                        ...
                                                        <tr>
                                                            <td class="myLabelIzquierda">Diagnosticos encontrados</td>
                                                            <td>&nbsp;</td>
                                                            <td class="myLabelIzquierda">Diagnosticos del Paciente</td>
                                                        </tr>
                                                        <tr>
