...
namespace WebLab.Turnos
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private object LeerDatos()
        {
            ...
            m_strSQL = @" SELECT Pa.idPaciente, 
 case when Pa.idestado=2 then numeroAdic else 
 convert(varchar,Pa.numeroDocumento) end + 
 case when Pa.idestado=2 then '-T' else '' end as dni,
