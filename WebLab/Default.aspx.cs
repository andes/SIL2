...
namespace WebLab
{
    ...
    {       
        ...
        private void IdentificarSIL()
        {
            ...
            else
            {
                ...
                if (oUser != null)
                {
                    ...
                    switch (oUser.IdPerfil.Nombre)//este perfil ya se grabo en loginefector en el usuario dependiendo del efector que se seleccionó.
                    {                    
        ...
        //private void IdentificarSIL_old()
        //{
        //    if (Session["idUsuario"] == null)
        //        Response.Redirect("logout.aspx", false);
        //    else
