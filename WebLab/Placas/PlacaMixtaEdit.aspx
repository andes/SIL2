<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="PlacaMixtaEdit.aspx.cs" Inherits="WebLab.Placas.PlacaMixtaEdit" ValidateRequest="false" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
     ...
     <div  style="width: 1500px" class="form-inline"   >
           <div class="panel panel-danger" runat="server" > 
                    <div class="panel-heading"> 
                        <h4 class="panel-title">PLACA</h4>
  <a href="javascript:imprSelec('muestra')" runat="server" id="textoimprimir" ><h4>Imprimir Placa</h4></a>
                       ...
                       <table class="myTabla" cellpadding="2" cellspacing="3">
                           <tr>
                            ...
                            <tr>
                               ...
                               <td align="center" bgcolor="#CCCCCC"><h4>NTC</h4></td>
                                 <td bgcolor="#CCCCCC"><input ID="txt_ABCD_2" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);"  onblur="valNumero(this)"   type="text" style="font-size: large; width: 115px;" 
                                                /></td>
                               <td bgcolor="#CCCCCC">
                                   <input ID="txt_ABCD_3" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                               <td bgcolor="#CCCCCC">
                                   <input ID="txt_ABCD_4" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                              <td bgcolor="#CCCCCC">
                                  <input ID="txt_ABCD_5" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_ABCD_6" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                              <td bgcolor="#CCCCCC">
                                  <input ID="txt_ABCD_7" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_ABCD_8" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                              <td bgcolor="#CCCCCC">
                                  <input ID="txt_ABCD_9" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                               <td bgcolor="#CCCCCC">
                                   <input ID="txt_ABCD_10" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                               <td bgcolor="#CCCCCC">
                                   <input ID="txt_ABCD_11" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_ABCD_12" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" onblur="valNumero(this)"  type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td bgcolor="#CCCCCC">
                                   <input ID="txt_EFGH_1" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                /></td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_2" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_3" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_4" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_5" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_6" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_7" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_8" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_9" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_10" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_11" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                                 <td bgcolor="#CCCCCC">
                                    <input ID="txt_EFGH_12" runat="server" class="form-control input-sm" onkeypress="javascript:return Enter(this, event);" type="text" style="font-size: large; width: 115px;" 
                                                />
                                </td>
                           </tr>
                            <tr>
