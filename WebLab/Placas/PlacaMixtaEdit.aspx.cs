...
namespace WebLab.Placas {
    public partial class PlacaMixtaEdit : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!IsPostBack)
            {
                ...
                if (Session["idUsuario"] != null)
                {
                    ...
                    {
                        if (Request["placa"].ToString() == "PromegaM")
                        {
                            lblEquipo.Text = "PromegaM"; pnlPromega.Visible = true; pnlAlplex.Visible = false; pnlPromega2.Visible = false;
                        }
                        //if (Request["placa"].ToString() == "Alplex")
        ...
        private void MostrarDatosPlaca()
        {
            ...
            {
                if (oDet.NamespaceID == "A2") txt_ABCD_2.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                 
                  //  if VerificaExistePlaca(oDet.IdDetalleProtocolo)txt_ABCD_2 : poner color o asterisco
                if (oDet.NamespaceID == "A3") txt_ABCD_3.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A4") txt_ABCD_4.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A5") txt_ABCD_5.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A6") txt_ABCD_6.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A7") txt_ABCD_7.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A8") txt_ABCD_8.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A9") txt_ABCD_9.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A10") txt_ABCD_10.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A11") txt_ABCD_11.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "A12") txt_ABCD_12.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);

            


                if (oDet.NamespaceID == "E1") txt_EFGH_1.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E2") txt_EFGH_2.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E3") txt_EFGH_3.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E4") txt_EFGH_4.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E5") txt_EFGH_5.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E6") txt_EFGH_6.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E7") txt_EFGH_7.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E8") txt_EFGH_8.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E9") txt_EFGH_9.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E10") txt_EFGH_10.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E11") txt_EFGH_11.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
                if (oDet.NamespaceID == "E12") txt_EFGH_12.Value = getNumeroProtocolo(oDet.IdDetalleProtocolo);
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    if (Request["id"] != null)
                    {
                        oRegistro.GrabarAuditoria("Modifica Placa", oUser.IdUsuario, "");

                    }
                    else oRegistro.GrabarAuditoria("Genera Placa", oUser.IdUsuario, "");
                    // guardarValorCelda (idPlaca, txt_AB_1.value)
                    Response.Redirect("PlacaMixtaEdit.aspx?id=" + oRegistro.IdPlaca.ToString());
                }
        ...
        private void Guardar(Placa oRegistro, string estado)
        {
            ...
            Item oItem = new Item();
            oItem = (Item)oItem.Get(typeof(Item), "Codigo", oC.CodigoCovid, "Baja", false);
            
            if (oRegistro.Equipo == "PromegaM") //Mixta
            {
                oRegistro.BorrarDetalle();
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_2.Value, txt_ABCD_2.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_3.Value, txt_ABCD_3.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_4.Value, txt_ABCD_4.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_5.Value, txt_ABCD_5.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_6.Value, txt_ABCD_6.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_7.Value, txt_ABCD_7.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_8.Value, txt_ABCD_8.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_9.Value, txt_ABCD_9.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_10.Value, txt_ABCD_10.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_11.Value, txt_ABCD_11.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_ABCD_12.Value, txt_ABCD_12.ID);

               

                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_1.Value, txt_EFGH_1.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_2.Value, txt_EFGH_2.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_2.Value, txt_EFGH_2.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_3.Value, txt_EFGH_3.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_4.Value, txt_EFGH_4.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_5.Value, txt_EFGH_5.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_6.Value, txt_EFGH_6.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_7.Value, txt_EFGH_7.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_8.Value, txt_EFGH_8.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_9.Value, txt_EFGH_9.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_10.Value, txt_EFGH_10.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_11.Value, txt_EFGH_11.ID);
                guardarvalorCeldaMixta(oRegistro,  txt_EFGH_12.Value, txt_EFGH_12.ID);
            ...
            if (oRegistro.Equipo == "Alplex") //Mixta
            {
                oRegistro.BorrarDetalle();
                ...
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA4.Value, txtA4.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA5.Value, txtA5.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA6.Value, txtA6.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA7.Value, txtA7.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA8.Value, txtA8.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA9.Value, txtA9.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtA10.Value, txtA10.ID);
                ...
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE1.Value, txtE1.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE2.Value, txtE2.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE3.Value, txtE3.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE4.Value, txtE4.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE5.Value, txtE5.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE6.Value, txtE6.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE7.Value, txtE7.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE8.Value, txtE8.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE9.Value, txtE9.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE10.Value, txtE10.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE11.Value, txtE11.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem1, txtE12.Value, txtE12.ID);

                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF1.Value, txtF1.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF2.Value, txtF2.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF3.Value, txtF3.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF4.Value, txtF4.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF5.Value, txtF5.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF6.Value, txtF6.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF7.Value, txtF7.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF8.Value, txtF8.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF9.Value, txtF9.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF10.Value, txtF10.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF11.Value, txtF11.ID);
                guardarvalorCeldaAlplex(oRegistro, oItem2, txtF12.Value, txtF12.ID);
        ...
        private void guardarvalorCeldaAlplex(Placa oRegistro, Item oItem, string value, string iD)
        {
            ...
            try {
                ...
                if (value != "")
                {
                    ...
                    oP = (Business.Data.Laboratorio.Protocolo)oP.Get(typeof(Business.Data.Laboratorio.Protocolo), "Numero", value, "IdEfector", oUser.IdEfector);
                        ...
                        if (items.Count > 0)
                        {
                            foreach (DetalleProtocolo oDet in items)
                            {
                                ...
                                if (oDet.IdUsuarioValida == 0)
                                {
                                    ...
                                    oDet.IdProtocolo.GrabarAuditoriaDetalleProtocolo("Vincula a Placa Alplex", oUser.IdUsuario, "", oRegistro.IdPlaca.ToString());
                                }
                                else
        ...
        private void guardarvalorCelda(Placa oRegistro, Item oItem, string value, string iD)
        {
            try {
                ...
                if (value != "")
                {
                    ...
                    if (oP != null)
                    {
                        // si es celda A: busca iditem de Flu A
                        // si es celda B: busca iditem de Flu B
                        ...
                        if (items.Count >= 0)
                        {
                            foreach (DetalleProtocolo oDet in items)
                            {
                                ...
                                if (oDet.IdUsuarioValida == 0)
                                {
                                    ...
                                    oDet.IdProtocolo.GrabarAuditoriaDetalleProtocolo("Vincula a Placa Promega", oUser.IdUsuario, "", oRegistro.IdPlaca.ToString());
                                }
                                else
        ...
        private void guardarvalorCeldaMixta(Placa oRegistro,  string value, string iD)
        {
            try
            {
                //levantar id=txt_AB_1 -- controlito
                string[] arr = iD.Split('_');
                string celda1 = arr[1].ToString(); //"ABCD"
                string celda2 = arr[2].ToString(); // "2"
                ...
                if (value != "")
                {
                    ...
                    if (oP != null)
                    {
                        for (int i = 0; i < celda1.Length-1; i++)
                        {
                            string letra = celda1.Substring(i, 1);
                            // si es celda A: busca iditem de Flu A
                            // si es celda B: busca iditem de Flu B
                            Item oItem = new Item();
                            if ((letra == "A") || (letra == "E"))
                            ...
                            if ((letra == "C")|| (letra == "G"))
                            {
                                oItem = (Item)oItem.Get(typeof(Item), "Codigo", "9122", "Baja", false);
                            ...
                            if (items.Count >= 0)
                            {
                                foreach (DetalleProtocolo oDet in items)
                                {
                                    ...
                                    if (oDet.IdUsuarioValida == 0)
                                    {
                                        ...
                                        oDetPlaca.IdPlaca = oRegistro.IdPlaca;
                                        oDetPlaca.NamespaceID = letra + celda2;
                                        oDetPlaca.IdDetalleProtocolo = oDet.IdDetalleProtocolo;

                                        oDetPlaca.Save();


                                        oDet.IdProtocolo.GrabarAuditoriaDetalleProtocolo("Vincula a Placa Promega", oUser.IdUsuario, oDet.IdSubItem.Nombre, oRegistro.IdPlaca.ToString());
                                    }
                                    else
                                    { Session["errores"] += "- Protocolo " + value + "  ya fue validado. No es posible incorporar en la placa"; }
        ...
        private void Imprimir(string id)
        {
            ...
            switch (oRegistro.Equipo)
            {
                ...
                oRegistro.GrabarAuditoria("Imprime Placa", oUser.IdUsuario, "");
