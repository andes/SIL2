...
{
    public partial class DiagList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = " select idDiagnostico,codigo,nombre from LAB_Diagnostico where baja=0 order by nombre";
        ...
        {
            Response.Redirect("DiagEdit.aspx");
        }
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                string MyURL;
                MyURL = "DiagEdit.aspx?id=" + e.CommandArgument.ToString();
        ...
        private void Eliminar(object p)
        {
            ...
            oRegistro = (DiagnosticoP)oRegistro.Get(typeof(DiagnosticoP), int.Parse(p.ToString()));
