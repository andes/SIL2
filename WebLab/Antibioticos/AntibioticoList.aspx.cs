...
{
    public partial class AntibioticoList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = " SELECT idAntibiotico , nombreCorto , descripcion " +
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                MyURL = "AntibioticoEdit.aspx?id=" + e.CommandArgument.ToString();
        ...
        private void Eliminar(object p)
        {
            ...
            oRegistro = (Antibiotico)oRegistro.Get(typeof(Antibiotico), int.Parse(p.ToString()));
