...
namespace WebLab.AutoAnalizador.SysmexXT1800
{
    public partial class ConfiguracionEdit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                VerificaPermisos("Config. Sysmex XT1800i");
                CargarCombos();
                CargarGrilla();
            }
        }
        ...
        private object LeerDatos()
        {
            string m_strSQL = @" SELECT     M.idSysmexItem, I.codigo, I.nombre, M.idSysmex, M.habilitado as Habilitado
                                 FROM  LAB_SysmexItemXT1800 AS M 
        ...
        {
            SysmexItemxt1800 oDetalle = new SysmexItemxt1800();
        ...
        private string existe()
        {
            ...
            SysmexItemxt1800 oItem = new SysmexItemxt1800();
            oItem = (SysmexItemxt1800)oItem.Get(typeof(SysmexItemxt1800), "IdItem", int.Parse(ddlItem.SelectedValue));
            if (oItem == null)
            {

                ISession m_session = NHibernateHttpModule.CurrentSession;
                ICriteria crit = m_session.CreateCriteria(typeof(SysmexItemxt1800));
        ...
        protected void gvLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                SysmexItemxt1800 oRegistro = new SysmexItemxt1800();
                oRegistro = (SysmexItemxt1800)oRegistro.Get(typeof(SysmexItemxt1800), int.Parse(e.CommandArgument.ToString()));
                oRegistro.Delete();
        ...
        protected void chkStatus_OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            SysmexItemxt1800 oRegistro = new SysmexItemxt1800();
            oRegistro = (SysmexItemxt1800)oRegistro.Get(typeof(SysmexItemxt1800), i_id);
