...
namespace WebLab.AutoAnalizador.Counter
{
    public partial class ConfiguracionEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                VerificaPermisos("Config. Counter");
                CargarCombos();
                CargarGrilla();
        ...
        {
            string m_strSQL = @" SELECT     M.idCounterItem, I.codigo, I.nombre, M.idCounter, M.habilitado as Habilitado
                                 FROM  LAB_CounterItem AS M (nolock)
                                 INNER JOIN LAB_Item AS I (nolock) ON M.idItem = I.idItem Order by I.nombre ";
        ...
        {
            CounterItem oDetalle = new CounterItem();
            oDetalle.IdCounter = ddlItemEquipo.SelectedItem.Text;
        ...
        private string existe()
        {
            ...
            CounterItem oItem = new CounterItem();
            oItem = (CounterItem)oItem.Get(typeof(CounterItem), "IdItem", int.Parse(ddlItem.SelectedValue));
            if (oItem == null)
            {

                ISession m_session = NHibernateHttpModule.CurrentSession;
                ICriteria crit = m_session.CreateCriteria(typeof(CounterItem));
                crit.Add(Expression.Eq("IdCounter",ddlItemEquipo.SelectedItem.Text));                
        ...
        protected void gvLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                CounterItem oRegistro = new CounterItem();
                oRegistro = (CounterItem)oRegistro.Get(typeof(CounterItem), int.Parse(e.CommandArgument.ToString()));
                oRegistro.Delete();
        ...
        protected void chkStatus_OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            CounterItem oRegistro = new CounterItem();
            oRegistro = (CounterItem)oRegistro.Get(typeof(CounterItem), i_id);
        ...
        {
          //  Response.Redirect("../PrincipalCounter.aspx", false);
        }
