...
namespace WebLab.AutoAnalizador.Incca
{
    public partial class ConfiguracionEdit2 : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = @" SELECT     M.idInccaItem, I.codigo, I.nombre, M.idIncca, M.habilitado as Habilitado, M.prefijo
                                 FROM  LAB_InccaItem AS M 
