<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfiguracionEdit2.aspx.cs" Inherits="WebLab.AutoAnalizador.Dirui_CS_Quimica.ConfiguracionEdit2" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">          
   ...
   <div class="panel panel-default">
    ...
    <h3 class="panel-title"> EQUIPO DIRUI CS-T240</h3>
                        </div>
       	...
       	<div class="panel-footer">
               			<div style="border: 1px solid #999999; height: 500px; width:610px; overflow: scroll;">
                                <asp:GridView ID="gvLista" runat="server"  CssClass="table table-bordered bs-table"  AutoGenerateColumns="False" Width="590px" 
                                    DataKeyNames="idDiruiItem" onrowcommand="gvLista_RowCommand" 
