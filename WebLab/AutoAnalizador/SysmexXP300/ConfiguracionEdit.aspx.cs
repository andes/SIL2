...
namespace WebLab.AutoAnalizador.SysmexXP300
{
    public partial class ConfiguracionEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                VerificaPermisos("Config. Sysmex XP300");
                CargarCombos();
                CargarGrilla();
        ...
        private object LeerDatos()
        {
            string m_strSQL = @" SELECT     M.idSysmexItem, I.codigo, I.nombre, M.idSysmex, M.habilitado as Habilitado
                                 FROM  LAB_SysmexItemXP300 AS M (nolock)
        ...
        {
            SysmexItemXP300 oDetalle = new SysmexItemXP300();
        ...
        private string existe()
        {
            ...
            SysmexItemXP300 oItem = new SysmexItemXP300();
            oItem = (SysmexItemXP300)oItem.Get(typeof(SysmexItemXP300), "IdItem", int.Parse(ddlItem.SelectedValue));
            if (oItem == null)
            {

                ISession m_session = NHibernateHttpModule.CurrentSession;
                ICriteria crit = m_session.CreateCriteria(typeof(SysmexItemXP300));
        ...
        protected void gvLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                SysmexItemXP300 oRegistro = new SysmexItemXP300();
                oRegistro = (SysmexItemXP300)oRegistro.Get(typeof(SysmexItemXP300), int.Parse(e.CommandArgument.ToString()));
                oRegistro.Delete();
        ...
        protected void chkStatus_OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            SysmexItemXP300 oRegistro = new SysmexItemXP300();
            oRegistro = (SysmexItemXP300)oRegistro.Get(typeof(SysmexItemXP300), i_id);
