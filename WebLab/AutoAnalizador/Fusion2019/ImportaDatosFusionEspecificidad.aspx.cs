...
{
    public partial class ImportaDatosFusionEspecificidad : System.Web.UI.Page
    {
        bool cargar = false;
        ...
        private void CargarGrillaEspecificidad()
        {
            ...
            FROM            LAB_MindrayResultado AS M where M.idEfector= " + oUser.IdEfector.IdEfector.ToString();
                ...
                if (arr.Length >= 5)
                {
                    ...
                    if (cargar)
                    {
                        ...
                        if (oUtil.EsNumerico(campo_cero))
                        {
                            ...
                            idProtocolo.Value = numeroProtocolo;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (ddlTipoArchivo.SelectedIndex ==
                0)
            {
                Guardar1();
