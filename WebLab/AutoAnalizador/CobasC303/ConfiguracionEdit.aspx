<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfiguracionEdit.aspx.cs" Inherits="WebLab.AutoAnalizador.CobasC303.ConfiguracionEdit" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">          
   ...
   <div class="panel panel-default">
    ...
    <h3 class="panel-title">Configuración SIL - CobasC303-C311-E411</h3>
                        </div>
...
<tr>
					...
					<tr>
						...
						<td style="width: 475px">
                            ...
                            <asp:dropdownlist ID="ddlEquipo" runat="server" class="form-control input-sm" AutoPostBack="True" OnSelectedIndexChanged="ddlEquipo_SelectedIndexChanged"
                                
                               >
                                <asp:ListItem Selected="True">CobasC303</asp:ListItem>
                                <asp:ListItem>CobasC311</asp:ListItem>
                                <asp:ListItem>CobasE411</asp:ListItem>
                            </asp:dropdownlist>
