<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfiguracionEdit.aspx.cs" Inherits="WebLab.AutoAnalizador.SysmexXN1000.ConfiguracionEdit" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">          
 <div align="left" style="width: 700px" class="form-inline"  >
   <div class="panel panel-default">
    ...
    <h3 class="panel-title">Configuración SIL - EQUIPO Sysmex XN1000</h3>
                        </div>
					...
					<tr>
						...
						<td style="width: 475px">
                            <asp:DropDownList ID="ddlItemEquipo" class="form-control input-sm" runat="server" Width="150px">
                                ...
                                <asp:ListItem Value="21">MPV</asp:ListItem>
                                <asp:ListItem Value="22">PCT</asp:ListItem>
                                <asp:ListItem Value="23">P-LCR</asp:ListItem>
                                <asp:ListItem Value="24">IG%</asp:ListItem>
                                <asp:ListItem Value="25">IG#</asp:ListItem>
                            </asp:DropDownList>
