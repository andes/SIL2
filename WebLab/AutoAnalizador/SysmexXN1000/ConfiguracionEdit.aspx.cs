...
namespace WebLab.AutoAnalizador.SysmexXN1000
{
    public partial class ConfiguracionEdit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                VerificaPermisos("Config. Sysmex XN1000");
                CargarCombos();
                CargarGrilla();
            }
        }
        ...
        private object LeerDatos()
        {
            string m_strSQL = @" SELECT     M.idSysmexItem, I.codigo, I.nombre, M.idSysmex, M.habilitado as Habilitado
                                 FROM  LAB_SysmexItemXN1000 AS M 
        ...
        {
            SysmexItemXN1000 oDetalle = new SysmexItemXN1000();
        ...
        private string existe()
        {
            ...
            SysmexItemXN1000 oItem = new SysmexItemXN1000();
            oItem = (SysmexItemXN1000)oItem.Get(typeof(SysmexItemXN1000), "IdItem", int.Parse(ddlItem.SelectedValue));
            if (oItem == null)
            {

                ISession m_session = NHibernateHttpModule.CurrentSession;
                ICriteria crit = m_session.CreateCriteria(typeof(SysmexItemXN1000));
        ...
        protected void gvLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                SysmexItemXN1000 oRegistro = new SysmexItemXN1000();
                oRegistro = (SysmexItemXN1000)oRegistro.Get(typeof(SysmexItemXN1000), int.Parse(e.CommandArgument.ToString()));
                oRegistro.Delete();
        ...
        protected void chkStatus_OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            SysmexItemXN1000 oRegistro = new SysmexItemXN1000();
            oRegistro = (SysmexItemXN1000)oRegistro.Get(typeof(SysmexItemXN1000), i_id);
