...
namespace WebLab.AutoAnalizador.Architect
{
    public partial class ConfiguracionEdit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                VerificaPermisos("Config. Architect");
                CargarCombos();
                CargarGrilla();
            }
        }
        ...
        {
            string m_strSQL = @" SELECT     M.idArchitecItem, I.codigo, I.nombre, M.idArchitec,M.prefijo, M.habilitado as Habilitado, M.dilucion
                                 FROM  LAB_ArchitecItem AS M 
        ...
        {
            ArchitecItem oDetalle = new ArchitecItem();
            oDetalle.IdArchitec= txtOrden.Text.Trim();
        ...
        private string existe()
        {
            ...
            ArchitecItem oItem = new ArchitecItem();
            oItem = (ArchitecItem)oItem.Get(typeof(ArchitecItem), "IdItem", int.Parse(ddlItem.SelectedValue), "Prefijo", txtPrefijo.Text.Trim());
            if (oItem == null)
            {

                ISession m_session = NHibernateHttpModule.CurrentSession;
                ICriteria crit = m_session.CreateCriteria(typeof(ArchitecItem));
                crit.Add(Expression.Eq("IdArchitec",txtOrden.Text.Trim()));                
        ...
        protected void gvLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                ArchitecItem oRegistro = new ArchitecItem();
                oRegistro = (ArchitecItem)oRegistro.Get(typeof(ArchitecItem), int.Parse(e.CommandArgument.ToString()));
                oRegistro.Delete();
                CargarGrilla();
            }
        }
        ...
        protected void chkStatus_OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            ArchitecItem oRegistro = new ArchitecItem();
            oRegistro = (ArchitecItem)oRegistro.Get(typeof(ArchitecItem), i_id);
