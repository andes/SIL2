...
{
    public partial class DefaultLC : System.Web.UI.Page
    {       
        ...
        private void IdentificarSGH()
        {
         ///sin uso
            ...
            Session["idEfectorSolicitante"] = "229";
        ...
        private void IdentificarSSO()
        {
            ...
            else
            {
                ...
                Session["idEfectorSolicitante"] = Salud.Security.SSO.SSOHelper.CurrentIdentity.IdEfector.ToString();
                
               Usuario oUser = new Usuario();
                oUser=buscarUsuarioLocal(Salud.Security.SSO.SSOHelper.CurrentIdentity.Username, Salud.Security.SSO.SSOHelper.CurrentIdentity.Surname, Salud.Security.SSO.SSOHelper.CurrentIdentity.FirstName);
        ...
        private Usuario buscarUsuarioLocal(string username, string v_apellido, string v_nombre )
        {
            Usuario oUser = new Usuario();
            ...
            else
            {
                ...
                oUserNew.IdEfector = oCon.IdEfector;
                oUserNew.Username = username;
                oUserNew.Apellido = v_apellido;
                oUserNew.Password = "";
                oUserNew.Nombre = v_nombre;
