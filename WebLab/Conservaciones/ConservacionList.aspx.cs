...
{
    public partial class ConservacionList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = @" select idConservacion,descripcion as nombre from Lab_Conservacion  (nolock)
                               where baja=0 
                               order by nombre";
        ...
        {
            Response.Redirect("ConservacionEdit.aspx");
        }
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                MyURL = "ConservacionEdit.aspx?id=" + e.CommandArgument.ToString();
        ...
        private void Eliminar(object p)
        {
            ...
            oRegistro = (Conservacion)oRegistro.Get(typeof(Conservacion), int.Parse(p.ToString()));
