<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConservacionList.aspx.cs" Inherits="WebLab.Conservaciones.ConservacionList" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
   ...
   <div class="panel panel-default">
    ...
    <h3 class="panel-title">LISTA DE SOPORTE/CONSERVACION</h3>
                        </div>
        ...
        <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" 
            ...
            onrowdatabound="gvLista_RowDataBound"      CssClass="table table-bordered bs-table"
                        EmptyDataText="No hay registros creados" 
