...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <table style="width: 1100px;"
                                        ...
                                        <td colspan="2">
                                            ...
                                            <table style="width: 100%; border-spacing: 5px; border-collapse: separate;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <label>Nro. Origen-Laboratorio:</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label>Efector Solicitante: </label>
                                                    </td>
                                                    <td colspan="3">
                                                    ...
                                                    <td>
                                                        <label>Médico Solicitante (MP): </label>
                                                    </td>
                                                    <td colspan="4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <label>
                                                            <asp:Label ID="lblSalaCama" runat="server">     Sala/Cama:                        </asp:Label></label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1" class="myLabelIzquierda">
                                                        <anthem:DropDownList Visible="false" ID="ddlCaracter" runat="server"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div id="tabContainer" style="width: 1150px; z-index: 1; position: relative;">
                                                            ...
                                                            <td>
                                                                <table cellpadding="1" cellspacing="0" runat="server" id="tableTitulo" class="tituloCelda">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 80px;">S/ Muestra</td>
                                                                ...
                                                                <div>
                                                                    <asp:CheckBox ID="chkRecordarPractica" runat="server" CssClass="myLabelGris"
                                             ...
                                             <span class="glyphicon glyphicon-ok-sign"></span></anthem:LinkButton>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <anthem:DropDownList ID="ddlItem" runat="server" AutoCallBack="True" Width="250px"
                                             ...
                                             <span class="glyphicon glyphicon-ok-sign"></span></anthem:LinkButton>
                                                ...
                                                <div id="tab2" style="height: 350px">
                                                 ...
                                                 <br />
                                                                    ...
                                                                    <tr>
                                                                        <td class="myLabelIzquierda" colspan="3">Nombre: 
                                                                            <br />
                                                                            <anthem:TextBox ID="txtNombreDiagnostico" runat="server" AutoCallBack="True"
                                                            ...
                                                            <td class="auto-style1">Diagnósticos encontrados<anthem:ListBox ID="lstDiagnosticos" runat="server" AutoCallBack="True"
                                                        ...
                                                        <tr>
                                                            <td class="auto-style1">
                                                                <div>
                                                                    &nbsp;<anthem:Label ID="lblFechaFIS" runat="server" Text="FIS:"></anthem:Label>
                                        ...
                                        <input id="txtFechaFUC" runat="server" type="text" maxlength="10"
                                            style="width: 120px" onblur="valFecha(this)"
                                            onkeyup="mascara(this,'/',patron,true)" tabindex="1" class="form-control input-sm" />
                                                                    <asp:CheckBox ID="chkSinFUC" runat="server" Text="Sin informar" />
                                                                </div>
                                                            </td>
                                                            <td style="vertical-align: top">&nbsp;</td>
                                         ...
                                         <td><anthem:LinkButton CssClass="myLink" ID="lnkReimprimirComprobante" onclick="lnkReimprimirComprobante_Click" runat="server">Reimprimir Comprobante</anthem:LinkButton>
                                                    ...
                                                    <asp:Panel ID="pnlEtiquetas" runat="server" Visible="false">
                                                        ...
                                                        <div>
                                                            <br />
                                                            Impresora de Etiquetas:  
                                                            <anthem:DropDownList class="form-control input-sm" ToolTip="Seleccione Impresora de Etiqueta" ID="ddlImpresora2" runat="server">
                                                            </anthem:DropDownList>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InicioPagina() {
            ...
            if (EsNuevoProtocolo()) {
                //No se cargaron valores todavia, se tiene que crear una nueva linea
                if (document.getElementById('<%= Page.Master.FindControl("ContentPlaceHolder1").FindControl("TxtDatosCargados").ClientID %>').value == "") {
                    CrearFila(true);
                }
                else //ya tiene valores, se debe recargar para no perderlos
                { 
                    postBack ? AgregarCargadoSinVerificar() : AgregarCargados(); //AgregarCargadoSinVerificar() no verifica si hay repetidos, en cambio AgregarCargados si
                }
            } else { //modificacion de protocolo 
                  postBack ? AgregarCargadoSinVerificar() : AgregarCargados();
            }
