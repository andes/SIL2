...
namespace WebLab.Protocolos
{
    public partial class DefaultFFEE2  : System.Web.UI.Page
    {
        ...
        private void ConectarWebService()
        {
            ...
            try
            {
              ...
              System.Net.SecurityProtocolType.Tls12;
                    ...
                    if ((ddlTipoFicha.SelectedValue == "600ceaf8220da69a4bbe7223") || (ddlTipoFicha.SelectedValue == "6257096489e70952a20eadc3") || (ddlTipoFicha.SelectedValue == "69a084acf1b15d16a778a706"))//covid o uma o virossis_respiratoria
                    {
        ...
        private string  Validacion(FFEE respuesta_d)
        {
            ...
            ////Caro: 12.05.2026. No vendrá el dato clasificacion
            /*string idcarac="";
        ...
        private bool GuardaFicha(FFEE respuesta_d)
        {
            try
            {
                ...
                string det = BuscarDeterminaciones(respuesta_d.Tipo_ficha, ID_ORIGEN);
           /* if (det == "")
                return false;
            else
            {
            */
                ...
                if (respuesta_d.clasificacion != null)// con viruses_repiratorios no viene la clasificacion
                    oRegistro.Clasificacion = respuesta_d.clasificacion;
                else
                    oRegistro.Clasificacion = "";
                ...
                /* if (respuesta_d.fechasintomas!= null)
                     ...
                     */
                System.DateTime fechaSintoma;

                if (!string.IsNullOrWhiteSpace(respuesta_d.fechasintomas) &&
                    System.DateTime.TryParse(respuesta_d.fechasintomas, out fechaSintoma))
                {
                    oRegistro.FechaSintoma = fechaSintoma;
                }
                ...
                System.DateTime fechamuestra;

                if (!string.IsNullOrWhiteSpace(respuesta_d.fechamuestra) &&
                    System.DateTime.TryParse(respuesta_d.fechamuestra, out fechamuestra))
                {
                    oRegistro.FechaToma = fechamuestra;
                }
                else oRegistro.FechaToma = DateTime.Parse(respuesta_d.Fecha);
       ...
       //     string tabla  = BuscarDeterminaciones(respuesta_d.Tipo_ficha, ID_ORIGEN);
       ...
       // }
        ...
        private string BuscarDeterminaciones(string Tipo_ficha, int ID_ORIGEN)
        {///CARO poner en la tabla las determinaciones por ficha dengue /sifilis
            Utility oUtil = new Utility();
            ///Carga del combo de determinaciones
            /// 
            string s_tipo = "Determinacion";

            if (Tipo_ficha == "virosis_respiratoria")
            {
                if (ID_ORIGEN == 1)  ///ambulatorio
                    s_tipo += "Ambulatorio";
                if (ID_ORIGEN == 2)  ///ambulatorio
                    s_tipo += "Internacion";
            }
