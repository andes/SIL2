<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProtocoloEditPesquisa_old.aspx.cs" Inherits="WebLab.Protocolos.ProtocoloEditPesquisa_old" MasterPageFile="~/Site1.Master" %>
                 ...
                 <table  width="100%" align="center">
					<tr>
						...
						<td colspan="2"  >
						    ...
						    <%--<input id="txtHoraNac" runat="server" class="form-control input-sm" maxlength="5" 
                    ...
                    <input id="txtFechaOrden" runat="server" type="text" maxlength="10" 
                       style="width: 100px"  onblur="valFecha(this)" 
                        onkeyup="mascara(this,'/',patron,true)" tabindex="2 " class="form-control input-sm"  /></td>
                                      <td class="myLabelIzquierda">
                                         Nro. de Origen: </td>
                                      <td class="myLabelIzquierda">
                                      <asp:TextBox ID="txtNumeroOrigen" runat="server" CssClass="form-control input-sm" Width="120px" 
                        ...
                        <td rowspan="3">
                            ...
                            <anthem:DropDownList ID="ddlEfector" runat="server"  Width="310px"
                                ToolTip="Seleccione el efector" TabIndex="4" CssClass="form-control input-sm" 
                                AutoCallBack="True" onselectedindexchanged="ddlEfector_SelectedIndexChanged">
                                    ...
                                    <td colspan="7">
                            <anthem:DropDownList ID="ddlEspecialista" runat="server"  Width="310px"
                                ToolTip="Seleccione el especialista" TabIndex="5" CssClass="form-control input-sm">
                            ...
                            <anthem:DropDownList ID="ddlOrigen" runat="server"  Width="150px"
                                ToolTip="Seleccione el origen" TabIndex="6" CssClass="form-control input-sm">
                            </anthem:DropDownList>                                        
                                        <asp:DropDownList ID="ddlSectorServicio"  CssClass="form-control input-sm" runat="server" TabIndex="7" Width="180px">
                                        </asp:DropDownList>
                            ...
                            <asp:DropDownList ID="ddlPrioridad" runat="server" 
                                ToolTip="Seleccione la prioridad" TabIndex="7" CssClass="form-control input-sm">
                            </asp:DropDownList>
                                ...
                                MinimumValue="1" Type="Integer" ValidationGroup="0">*</asp:RangeValidator>
                                      ...
                                      <td class="myLabelIzquierda">  
                                      <asp:TextBox ID="txtSala" runat="server" CssClass="form-control input-sm" Width="40px" 
                                            TabIndex="8" MaxLength="50"></asp:TextBox>
                                        <asp:TextBox ID="txtCama" runat="server" CssClass="form-control input-sm" Width="40px" 
                       ...
                       <%--         <tr>
                        ...
                        style="width: 35px" 
                        tabindex="10" class="form-control input-sm"   /><asp:Label ID="lblUnidadEdad" runat="server" CssClass="myLabelIzquierdaGde" 
                                    ...
                                    <td align="right" class="myLabelIzquierda">
                                             Sexo:</td>
                                    <td align="left" >
                                            <anthem:DropDownList ID="ddlSexo" runat="server" CssClass="form-control input-sm" 
                                       ...
                                       <td class="myLabelIzquierda">
                                           Obra Social:  </td>
                                    <td colspan="7"> 
                                    <asp:DropDownList ID="ddlObraSocial" runat="server" CssClass="form-control input-sm" 
						...
						<hr />
                          Muestra a Analizar: &nbsp; &nbsp; 
                            <anthem:TextBox ID="txtCodigoMuestra" Width="50px"  CssClass="form-control input-sm" runat="server"   AutoCallBack="true"></anthem:TextBox> 
                            <anthem:DropDownList ID="ddlMuestra" runat="server" AutoCallBack="true"  onselectedindexchanged="ddlMuestra_SelectedIndexChanged"  CssClass="form-control input-sm" >
                            </anthem:DropDownList>
					...
					<div id="tabContainer" style="width: 1150px; z-index:2; position:relative;" >  
                                         ...
                                         <tr>
                                           <td class="myLabelIzquierda" colspan="4" >
                                               ...
                                               <anthem:ListBox ID="lstDiagnosticos" runat="server" AutoCallBack="True" 
                                                   CssClass="form-control input-sm" Height="120px" Width="400px">
                                               </anthem:ListBox>
                             ...
                             <div id="tab3" class="tab_content" style="height: 310px">
                                 <table style="width: 100%;">
                                     <tr>
                                         ...
                                         <td  class="myLabelIzquierda">
                                             <asp:DropDownList CssClass="form-control input-sm"   ToolTip="Seleccione Impresora" ID="ddlImpresora" runat="server">
                                             </asp:DropDownList>
                                         </td>
                                     ...
                                     <tr>
                                         ...
                                         <td  class="myLabelIzquierda" style="vertical-align: top">
                                             ...
                                             <asp:DropDownList CssClass="form-control input-sm" ToolTip="Seleccione Impresora de Etiqueta" ID="ddlImpresoraEtiqueta" runat="server">
                                             </asp:DropDownList>
                                         </td>
                                         <td style="vertical-align: top">
                 ...
                 <%--            <div id="tab4" class="tab_content"  style="height: 280px">
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td class="myLabelIzquierda">                                            
                                            <asp:TextBox ID="txtMatricula" runat="server" CssClass="form-control input-sm" 
                                                Width="52px">                                                                                         
                                            </asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="myLabelIzquierda">                                            
                                            <asp:TextBox ID="txtApellidoSolicitante" runat="server" CssClass="form-control input-sm" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="myLabelIzquierda">                                            
                                            <asp:TextBox ID="txtNombreSolicitante" runat="server" CssClass="form-control input-sm" 
                                               Width="131px">                                                                                                                                    
                                            </asp:TextBox>
					...
					<tr>
							<td colspan="2" style="vertical-align: top" class="myLabelIzquierda" >  Observaciones Internas:  
					...
					<tr>
						...
						<td align="left" >
                                            ...
                                            <asp:Button ID="btnCancelar" runat="server" Text="Regresar" 
                                                onclick="btnCancelar_Click" CssClass="btn btn-primary" Width="80px"  TabIndex="24" 
