<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProtocoloEliminar.aspx.cs" Inherits="WebLab.Protocolos.ProtocoloEliminar"  %>
...
<body  style="height:500px">  
    <form id="form1" runat="server"  >           
     ...
     <asp:Label ID="lblTitulo" runat="server" Text="Label" Font-Size="16pt"></asp:Label>    
                        </div>
