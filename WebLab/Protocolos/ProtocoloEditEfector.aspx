<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProtocoloEditEfector.aspx.cs" Inherits="WebLab.Protocolos.ProtocoloEditEfector" MasterPageFile="~/Resultados/SitePE.Master" %>
...
<td    >  
 <h4>  <label class = "label label-danger"> Caracter-CoVid19: </label></h4>
						...
						<td colspan="2" ><hr />
                            <asp:Panel ID="Panel1" runat="server">
                               <div class="input-group">
                                     <h3>
                                         <asp:Label ID="lblDeterminacion" runat="server" Text="Label"></asp:Label>  - Resultado </h3>
                                   </div>
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddlResultado" runat="server" class="form-control input-sm" TabIndex="8" Width="250px">
                                            </asp:DropDownList><asp:RangeValidator ID="rvResultado" runat="server" ErrorMessage="Debe ingresar resultado" ControlToValidate="ddlResultado" MaximumValue="9999999" MinimumValue="1" Type="Integer" ValidationGroup="0"></asp:RangeValidator>
                                        </div>
    ...
    <li><a href="#tab2">Diagnósticos<img alt="tiene diagnostico" runat="server" id="diag" visible="false" style="border:none;" src="~/App_Themes/default/images/red_pin.gif" /></a></li>
        <%--  <li><a href="#tab3">Impresiones</a></li>--%>        <%--<div id="tab4" class="tab_content"  style="height: 280px">
                              ...
                              <anthem:Button ID="btnRecordarDiagnostico" CssClass="btn btn-danger" Width="160px" runat="server" Text="Cargar Ultimos Dx" 
                                             ...
                                             <td class="auto-style1">                                               
                                               ...
                                               Diagnósticos encontrados<anthem:ListBox ID="lstDiagnosticos" runat="server" AutoCallBack="True" 
                                                     class="form-control input-sm"  Height="100px" Width="650px">
                                               </anthem:ListBox>
                                     ...
                                     <tr>
                                         <td class="myLabelIzquierda" style="vertical-align: top; width: 222px;">
                                             <asp:Label ID="lblImprimeCodigoBarras" runat="server" Text=" Imprimir códigos de barras:"></asp:Label>   
                                               ...
                                               <asp:TextBox ID="uip" runat="server" Text="ip"></asp:TextBox>  
  ...
  <ul class="pagination">
                                     <li>                         
                                         ...
                                         <td   style="vertical-align: top">
                                              <ul class="pagination">
                                     <li>  
                                             <anthem:CheckBoxList class="myLabelIzquierda"   ID="chkAreaCodigoBarra" runat="server" RepeatColumns="2"></anthem:CheckBoxList> 
                                         </li>
                                </ul>                                            
                                     ...
                                     <tr>
                                         ...
                                         <td colspan="2" align="right" >                                             
                                             ...
                                             <asp:CheckBox ID="chkCodificaPaciente" runat="server" class="form-control input-sm"
							...
							<td colspan="2" style="vertical-align: top" class="myLabelIzquierda" >  
                                ...
                                Observaciones Internas:  						
                                    <asp:TextBox ID="txtObservacion" runat="server" class="form-control input-sm" 
                                                TextMode="MultiLine"  TabIndex="23" Width="800px"  ></asp:TextBox>           
