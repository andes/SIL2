...
{
    public partial class AmplificacionList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = " select idAmplificacion as idAmplificacion,nombre" +
                              " from LAB_Amplificacion" +                              
                              " where baja=0 " +
                              " order by nombre";
        ...
        {
            Response.Redirect("AmplificacionEdit.aspx");
        }
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                MyURL = "AmplificacionEdit.aspx?id=" + e.CommandArgument.ToString();
        ...
        private void Eliminar(object p)
        {
            ...
            oRegistro = (Amplificacion)oRegistro.Get(typeof(Amplificacion), int.Parse(p.ToString()));
