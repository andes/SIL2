...
{
    public partial class CaracterList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = " select idCaracter,nombre  from Lab_Caracter with (nolock)  order by nombre";
        ...
        {
            Response.Redirect("CaracterEdit.aspx");
        }
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                MyURL = "CaracterEdit.aspx?id=" + e.CommandArgument.ToString();
        ...
        private void Eliminar(object p)
        {
           ...
           // oRegistro = (Caracter)oRegistro.Get(typeof(Caracter), int.Parse(p.ToString()));
