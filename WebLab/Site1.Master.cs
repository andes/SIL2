...
namespace WebLab
{
    public partial class Site1 : System.Web.UI.MasterPage {  
        ...
        private DataTable CrearMenuSecundario(string user,string p)
        {
            ...
            string m_strSQL = @"select  idMenu, objeto , idMenusuperior, urlmenu,permiso  from LAB_MenuTempUsuario  WHERE 
            idMenusuperior = " + p + " and permiso > 0 and (idUsuario = " + user + ")  ORDER BY posicion ";
...
//";
            string m_strSQL = "select  idMenu, objeto , idMenusuperior, urlmenu,permiso, idusuario, idEfector from LAB_MenuTempUsuario where idusuario=" + oUser.IdUsuario.ToString() + " and idEfector=" + oUser.IdEfector.IdEfector.ToString();
