<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeguimientoTestAntigenos.aspx.cs"
     Inherits="WebLab.SeguimientoTestAntigenos" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
  ...
  <div   class="panel panel-primary">
   <div class="panel-heading">  <h3>TEST ANTIGENOS COVID-19:Resultados informados</h3>
        </div>
                 ...
                 <br />
                   ...
                   <div class="form-group" >
                       <strong>      Resultado: </strong><asp:DropDownList ID="ddlResultado" runat="server" 
                        ...
                        <div class="form-group" > 
                        <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar"  CssClass="btn btn-primary" Width="100px"/>
                             <asp:Button ID="btnExcel" runat="server" OnClick="btnExcel_Click" Text="Exportar Excel"  CssClass="btn btn-primary" Width="150px"/>
        ...
        <asp:GridView ID="GridResultados"  CssClass="table table-bordered bs-table"  runat="server" Width="600px" Font-Size="8pt" RowDataBound="GridView1_RowDataBound" Font-Names="Verdana" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound1">
            <Columns>
               ...
               <asp:BoundField DataField="Obra Social" HeaderText="Obra Social" />
                ...
                <asp:BoundField DataField="Test Antigeno CoVid-19" HeaderText="Test Antigeno CoVid-19" />
