<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoriaClinicaFiltro.aspx.cs" Inherits="WebLab.Consulta.HistoriaClinicaFiltro" MasterPageFile="~/Consulta/SitePE.Master" %>
    ...
    <h3 class="panel-title"><asp:Label ID="lblTitulo" runat="server" Text="Label"></asp:Label></h3>
				...
				<div class="panel-body">	
				 ...
				 <table  width="790px"  cellpadding="1" cellspacing="1"   >                     
					...
					<tr>
						   <td colspan="2" style="color: #333333; font-weight: bold; font-size: 12px; vertical-align: top;"></td>
						   <td colspan="2" 
					...
					--%>
                          ...
                          <div class="panel-footer">
                              <div>
                                ...
                                DataKeyNames="numeroDocumento" CssClass="table table-bordered bs-table"  PageSize="20" 
