<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoView.aspx.cs" Inherits="WebLab.Consulta.ResultadoView" MasterPageFile="~/Consulta/SitePE.Master"  UICulture="es" Culture="es-AR" %>
                 ...
                 <table    >
					...
					<tr>
						...
						<td   style="vertical-align: top">
                                        ...
                                        <div  style="width:225px;height:350pt;overflow:scroll;overflow-x:hidden;border:1px solid #CCCCCC;"> 
...
<asp:HiddenField runat="server" ID="HFCurrTabIndex" /> 
        ...
        <table width="100%">
        	...
        	<tr>
						...
						<td align="right"  > 
						       <span id="spanadjunto" Visible="false" runat="server" class="label label-danger">
                                   <asp:Label ID="lblAdjunto" Visible="false" runat="server" Text="El protocolo tiene archivos adjuntos"></asp:Label></span>
                            </td>
        ...
        <div class="panel-footer">	
               ...
               <asp:LinkButton ID="imgPdf"  runat="server" CssClass="btn btn-info" Text="Buscar" OnClick="imgPdf_Click" Width="140px" >
                                             <span class="glyphicon glyphicon-download-alt"></span>&nbsp;Descargar</asp:LinkButton>

                 <asp:LinkButton ID="imgAdjunto" Visible="false" runat="server" CssClass="btn btn-info" Text="Buscar"  OnClientClick="AdjuntoProtocoloEdit(); return false;"   Width="160px" >
