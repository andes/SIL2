<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetodoList.aspx.cs" Inherits="WebLab.Metodos.MetodoList" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
   ...
   <div class="panel panel-default">
    ...
    <h3 class="panel-title">LISTA DE METODOS</h3>
                        </div>
        ...
        <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" 
            ...
            onrowdatabound="gvLista_RowDataBound" Font-Size="10pt" Width="100%" 
                        EmptyDataText="No hay métodos creados" CssClass="table table-bordered bs-table" >
