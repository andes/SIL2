...
{
    public partial class MetodoList : System.Web.UI.Page
    {
        ...
        {
            string m_strSQL = @" select idMetodo,nombre from Lab_Metodo (nolock)
                               where baja=0 
                               order by nombre";
        ...
        {
            Response.Redirect("MetodoEdit.aspx");
        }
        ...
        protected void gvLista_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                MyURL = "MetodoEdit.aspx?id=" + e.CommandArgument.ToString();
