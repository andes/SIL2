...
namespace Business.Data.AutoAnalizador
{
	...
	/// </summary>
	[Serializable]
	public sealed class ArchitecItem: Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

		private int m_idArchitecitem; 
		private string m_idArchitec; 
		...
		/// 
		/// </summary>
		public int IdArchitecItem
		{
			get { return m_idArchitecitem; }
			set
			{
				m_isChanged |= ( m_idArchitecitem != value ); 
				m_idArchitecitem = value;
			}
		...
		/// 
		/// </summary>
		public string IdArchitec
		{
			get { return m_idArchitec; }

			set	
			{	
				if( value == null )
					throw new ArgumentOutOfRangeException("Null value not allowed for IdArchitec", value, "null");
				
				if(  value.Length > 50)
					throw new ArgumentOutOfRangeException("Invalid value for IdArchitec", value, value.ToString());
				
				m_isChanged |= (m_idArchitec != value); m_idArchitec = value;
			}
		}
