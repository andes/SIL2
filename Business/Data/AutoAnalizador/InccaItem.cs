...
namespace Business.Data.AutoAnalizador
{
    ...
    /// </summary>
    [Serializable]
    public sealed class InccaItem: Business.BaseDataAccess
    {

        #region Private Members
        private bool m_isChanged;

        private int m_idInccaitem;
        private string m_idIncca;
        ...
        /// 
        /// </summary>
        public int IdInccaItem
        {
            get { return m_idInccaitem; }
            set
            {
                m_isChanged |= (m_idInccaitem != value);
                m_idInccaitem = value;
            }
        ...
        /// 
        /// </summary>
        public string IdIncca
        {
            get { return m_idIncca; }

            set
            {
                if (value == null)
                    throw new ArgumentOutOfRangeException("Null value not allowed for IdIncca", value, "null");

                if (value.Length > 50)
                    throw new ArgumentOutOfRangeException("Invalid value for IdIncca", value, value.ToString());

                m_isChanged |= (m_idIncca != value); m_idIncca = value;
            }
        }
