...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
    public sealed class Marca : Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

		private int m_idmarcaequipo; 		
		...
		/// 
		/// </summary>
		public int IdMarcaEquipo
		{
			get { return m_idmarcaequipo; }
			set
			{
				m_isChanged |= (m_idmarcaequipo != value );
                m_idmarcaequipo = value;
			}
        ...
        public bool TienePresentacion()
        {
            bool tiene = false;                    
            ICriteria crit2 = m_session.CreateCriteria(typeof(ItemPresentacion));
            crit2.Add(NHibernate.Expression.Expression.Eq("IdMarca", this.IdMarcaEquipo));
            
            // borra si existiesen
            IList items2 = crit2.List();
                if (items2.Count > 0) tiene=true;
