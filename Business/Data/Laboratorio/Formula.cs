...
namespace Business.Data.Laboratorio
{
	...
	public sealed class Formula: Business.BaseDataAccess
	{
        ...
        private string m_condicionDeterminacion;
        ...
        public Formula()
		{
            ...
            m_edadhasta = 0;
            m_unidadedad = 0;
            m_condicionDeterminacion = String.Empty;
			...
			: this()
		{
            ...
            m_condicionDeterminacion = condicionDeterminacion;
            m_sexo = sexo;
        ...
        public string CondicionDeterminacion
        {
            get { return m_condicionDeterminacion; }

            set
            {
                if (value == null)
                    throw new ArgumentOutOfRangeException("Null value not allowed for m_condicionDeterminacion", value, "null");

                if (value.Length > 2000)
                    throw new ArgumentOutOfRangeException("Invalid value for m_condicionDeterminacion", value, value.ToString());

                m_isChanged |= (m_condicionDeterminacion != value); m_condicionDeterminacion = value;
            }
        }
