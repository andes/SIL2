...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
    public sealed class ValorReferenciaNoPac : Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

		private int m_idvalorrefNoPaciente; 
	...
	/*	private string m_sexo; 
		...
		/// default constructor
		/// </summary>
		public ValorReferenciaNoPac()
		{
			m_idvalorrefNoPaciente = 0; 
	...
	/*		m_sexo = sexo;
		...
		/// 
		/// </summary>
		public int IdValorRefNoPaciente
        {
			get { return m_idvalorrefNoPaciente; }
			set
			{
				m_isChanged |= (m_idvalorrefNoPaciente != value );
                m_idvalorrefNoPaciente = value;
			}
