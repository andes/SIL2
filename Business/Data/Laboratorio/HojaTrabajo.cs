...
namespace Business.Data.Laboratorio
{
	...
	public sealed class HojaTrabajo: Business.BaseDataAccess
	{
        ...
        private bool m_imprimirmuestra;
			...
			: this()
		{
            ...
            m_imprimirmedico =imprimirmedico;
            m_imprimirmuestra =imprimirmuestra;
        ...
        public bool ImprimirMuestra
        {
            get { return m_imprimirmuestra; }
            set
            {
        ...
        public bool AgrupaFecha
        {
            get { return m_agrupafecha; }
            set
            {
                m_isChanged |= (m_agrupafecha != value);
                m_agrupafecha = value;
            }
 ...
 union
 select  "+ this.IdHojaTrabajo.ToString()+ @" as idhojatrabajo, '02' as linea, 'p' as pac 
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '03' as linea, 'p' as pac
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '04' as linea, 'p' as pac 
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '05' as linea, 'p' as pac
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '06' as linea, 'p' as pac 
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '07' as linea, 'p' as pac
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '08' as linea, 'p' as pac 
union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '09' as linea, 'p' as pac 
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '10' as linea, 'p' as pac
 union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '11' as linea, 'p' as pac 
union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '12' as linea, 'p' as pac 
union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '13' as linea, 'p' as pac 
union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '14' as linea, 'p' as pac 
union
 select " + this.IdHojaTrabajo.ToString() + @"  as idhojatrabajo, '15' as linea, 'p' as pac 
...
inner join lineas as L on l.idhojatrabajo= HT.idHojaTrabajo
            ...
            //" FROM         LAB_Area AS A " +
            //" INNER JOIN   LAB_Item AS I ON A.idArea = I.idArea  " +
