...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
	public sealed class Muestra: Business.BaseDataAccess
	{
        ...
        public string Codigo
        {
            ...
            {
                if (value == null)
                    throw new ArgumentOutOfRangeException("Null value not allowed for m_codigo", value, "null");

                if (value.Length > 50)
                    throw new ArgumentOutOfRangeException("Invalid value for m_codigo", value, value.ToString());
