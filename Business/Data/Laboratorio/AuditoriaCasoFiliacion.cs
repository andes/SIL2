...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
	public sealed class AuditoriaCasoFiliacion : Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

        private int m_idauditoriacasofiliacion; 
		...
		/// default constructor
		/// </summary>
		public AuditoriaCasoFiliacion()
		{
            m_idauditoriacasofiliacion = 0;
            m_idcasofiliacion = 0; 
		...
		/// 
		/// </summary>
        public int IdAuditoriaCasoFiliacion
		{
            get { return m_idauditoriacasofiliacion; }
			set
			{
                m_isChanged |= (m_idauditoriacasofiliacion != value);
                m_idauditoriacasofiliacion = value;
			}
        ...
        public string GetUsuario()
        {
            ...
            oUser = (Usuario)oUser.Get(typeof(Usuario),this.IdUsuario);
            return oUser.Apellido + " " + oUser.Nombre + " " + this.Fecha.ToShortDateString() + " "  + this.Fecha.ToShortTimeString();
        }
