...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
    public sealed class ParentescoAlegado : Business.BaseDataAccess
	{
        ...
        {
            CasoFiliacionProtocolo oItem = new CasoFiliacionProtocolo();
            ISession m_session = NHibernateHttpModule.CurrentSession;
            ICriteria crit = m_session.CreateCriteria(typeof(CasoFiliacionProtocolo));
            crit.Add(Expression.Eq("IdTipoParentesco", this.IdParentesco));
