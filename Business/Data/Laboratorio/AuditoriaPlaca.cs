...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
	public sealed class AuditoriaPlaca : Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

        private int m_idauditoriaplaca; 
		...
		/// default constructor
		/// </summary>
		public AuditoriaPlaca()
		{
            m_idauditoriaplaca = 0;
            m_idplaca = 0; 
		...
		/// 
		/// </summary>
        public int IdAuditoriaPlaca
        {
            get { return m_idauditoriaplaca; }
			set
			{
                m_isChanged |= (m_idauditoriaplaca != value);
                m_idauditoriaplaca = value;
			}
